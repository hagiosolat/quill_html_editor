...
class _MyAppState extends State<MyApp> {
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                ElevatedButton(onPressed: (){
                                    ...
                                    controller.setFormat(format: 'background',value: '#FF9800', index: index, length: length);
                                   Navigator.pop(context);
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        floatingActionButton:    selectedTextlength >= 1 ? !kIsWeb ? ElevatedButton(
                  ...
                  if(selection.length == 0) {
                    ScaffoldMessenger.of(context).showSnackBar( 
                      const SnackBar(content: Text('Select text to comment on')),
                       ...
                       showModalSheetScreen(selectedTextPosition, selectedTextlength);

                  }
                },
                child: const Text('Add Comment')) : const SizedBox.shrink() : const SizedBox.shrink(),
        backgroundColor: Colors.white,
        resizeToAvoidBottomInset: true,
                body: kIsWeb ? CustomScrollView(
                  slivers: [
                    SliverToBoxAdapter(
                      child: Column(
                        children: [
                      ...
                      child: Column(children: [
                        ...
                        Row(children: [
                          Flexible(
                            flex: 3,
                            child: editor()),
                             _comments.isEmpty ? const SizedBox.shrink() :
                            Container(                              
            ...
            bottomNavigationBar: kIsWeb ? selectedTextlength >= 1 ?    
        Container(
           width: double.maxFinite,
            padding: const EdgeInsets.all(8.0),
                  margin: const EdgeInsets.only(bottom: 10),
